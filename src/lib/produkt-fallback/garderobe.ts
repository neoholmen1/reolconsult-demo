...
/** Brukes til kunden har lagt inn produkter for denne kategorien i admin. */
export const FALLBACK_PRODUCTS: CategoryProduct[] = [
  {
    id: "garderobeskap",
    title: "Garderobeskap",
...
/** Hero- og CTA-tekst som brukes til CMS-et har innhold for siden. */
