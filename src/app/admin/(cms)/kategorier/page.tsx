...
export default function KategorierPage() {
  ...
  return (
    <>
      <PageHeader
        title="Kategorier"
        subtitle="Hovedkategoriene som vises på forsiden og under /produkter"
        right={
          <button
            onClick={add}
          ...
          >
            <Plus className="h-4 w-4" strokeWidth={2.25} /> Ny kategori
          </button>
        }
      />
        ...
        <div className="mx-auto max-w-3xl space-y-3">
          {loading ? (
            ...
            <EmptyState
              ...
              description="Kategoriene styrer hvordan produkter grupperes på forsiden og produktoversikten. Reolconsult har vanligvis Lager, Butikk, Kontor osv."
