          ...
          <div className="grid items-center gap-14 md:grid-cols-2">
            <AnimateOnScroll>
              ...
              <p className="mt-6 text-lg leading-relaxed text-text-muted">
                Reol-Consult AS ble etablert i november 1984 og er i dag
                Østlandets største leverandør med det bredeste sortimentet innen
                butikk-, lager-, verksted-, kontor-, arkiv- og
                garderobeinnredning.
              </p>
              <p className="mt-4 text-lg leading-relaxed text-text-muted">
                Vi leverer effektive og konkurransedyktige løsninger fra idé til
                ferdig sluttprodukt. Med over 40 års erfaring kjenner vi
                bransjen ut og inn, og hjelper deg med alt fra planlegging og
                tegning til montering.
              </p>
            </AnimateOnScroll>
          ...
          <div className="mt-16 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
            {[
              ...
              <AnimateOnScroll key={item.title} delay={i * 0.1}>
                <div className="rounded-2xl border border-black/[0.04] bg-white p-8 transition-shadow duration-300 hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)]">
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid items-center gap-14 md:grid-cols-2">
            ...
            <AnimateOnScroll delay={0.2}>
              ...
              <a
                href="/kontakt"
                className="mt-8 inline-flex items-center gap-2 rounded-full bg-accent px-7 py-3.5 font-semibold text-white transition-all duration-300 hover:bg-accent-hover hover:shadow-[0_8px_30px_rgba(212,32,39,0.25)]"
              >
                Kontakt oss
                <svg
                  className="h-4 w-4"
